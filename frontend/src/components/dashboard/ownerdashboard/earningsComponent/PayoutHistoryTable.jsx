import { payoutHistory, methodIcons, payoutTableHeaders } from "../../../../data";
                    ...
                    {payoutHistory.map((payout) => {
                        ...
                        return (
                            <tr key={payout.id} className="border-b border-gray-50 last:border-0">
                                ...
                                <td className="py-4">
                                    <span className={`text-xs font-semibold px-2.5 py-1 rounded-lg ${payout.statusColor}`}>
                                        {payout.status}
                                    </span>
                                </td>
                            </tr>
