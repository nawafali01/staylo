...
import { revenueStatsData, revenuePeriodOptions, revenueOverviewChartConfig } from "../../../../data";
...
function RevenueOverviewChart() {
    ...
    const { width: chartWidth, height: chartHeight, padding: chartPadding } = revenueOverviewChartConfig;
