...
import AccountSettingSecurity from "./AccountSettingSecurity";
import AccountSettingBadge from "./AccountSettingBadge";
    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1fr_380px] gap-6">
        <div className="flex flex-col gap-6">
          ...
          <AccountSettingSecurity onEnable={() => toast.success("2FA started")} />
        </div>

        <div className="flex flex-col gap-6">
          <AccountSettingCard className="p-7">
            <div className="flex items-center gap-2.5 mb-6">
