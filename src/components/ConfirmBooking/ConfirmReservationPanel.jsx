    ...
    <div className="bg-white border border-gray-200 rounded-xl p-6">
      ...
      <div className="grid grid-cols-2 gap-3 mb-4">
        <div className="border border-gray-200 rounded-lg px-3 py-2">
          ...
          <p className="text-sm text-gray-900">📅 Oct 05, 2024</p>
        </div>
        <div className="border border-gray-200 rounded-lg px-3 py-2">
          <p className="text-xs text-gray-400 uppercase tracking-wide mb-1">Check-out</p>
          <p className="text-sm text-gray-900">📅 Oct 10, 2024</p>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between border border-gray-200 rounded-lg px-3 py-3 mb-5">
        <div>
          ...
          <p className="text-sm text-gray-900">2 Adults, 1 Child</p>
        </div>
      ...
      <div className="space-y-2 mb-4">
        <div className="flex justify-between text-sm text-gray-500">
          <span>${property.price.toLocaleString()} × 5 nights</span>
      ...
      <div className="flex items-center justify-between border border-gray-200 rounded-lg px-3 py-3 mb-5">
        <span className="text-sm text-gray-900">Credit Card (Ending in 4421)</span>
        <span className="text-gray-400">▾</span>
      </div>
