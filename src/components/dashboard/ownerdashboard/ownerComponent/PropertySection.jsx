  ...
  return (
    <section className="mb-12">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-xl font-bold text-gray-900">My Properties Overview</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        {ownerPropertiesData.slice(0, 3).map((property) => {
          ...
          return (
            <div key={property.id} className="bg-white rounded-[32px] overflow-hidden border border-gray-100 shadow-sm hover:shadow-xl transition-all group">
              <div className="relative h-56">
                ...
                />
                <div className={`absolute top-4 right-4 px-4 py-1.5 rounded-xl text-[10px] font-bold uppercase tracking-widest backdrop-blur-md ${status.badge} shadow-lg shadow-black/5`}>
                  {status.text}
                </div>
              </div>
                  ...
                  <div className="flex flex-col gap-1">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[11px] font-bold text-gray-400 uppercase tracking-wider">
                        {property.occupancyStatus === 'occupied' ? '92% Occupancy' : '0% Occupancy'}
                      </span>
                    </div>
                  </div>
