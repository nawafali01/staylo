...
const UserTable = () => (
  <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
    <div className="flex justify-between items-center mb-6">
      ...
      <button className="text-blue-600 font-medium hover:text-blue-700">View Directory</button>
    </div>
    <div className="overflow-x-auto">
      <table className="w-full">
        <thead>
          <tr className="border-b border-gray-200 text-left">
            <th className="py-3 px-4 font-medium text-gray-600 text-sm">USER</th>
            ...
            <th className="py-3 px-4 font-medium text-gray-600 text-sm">ACTION</th>
          </tr>
        </thead>
        <tbody>
          {recentUsers.map((userData) => (
            <tr key={userData.id} className="border-b border-gray-100 last:border-0">
