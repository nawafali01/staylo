    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-md transition-shadow">
      ...
      <div className="p-5">
        ...
        <div className="flex gap-2">
          <button className="flex-1 px-4 py-2.5 border border-gray-300 text-gray-700 rounded-lg font-medium hover:bg-gray-50 transition-colors">
            Edit Property
          </button>
        ...
        <button className="w-full mt-2 px-4 py-2.5 border border-orange-300 text-orange-600 rounded-lg font-medium hover:bg-orange-50 transition-colors">
          Manage Bookings
        </button>
      </div>
    </div>
