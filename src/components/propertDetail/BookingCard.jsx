  ...
  return (
    <div className="border border-gray-200 rounded-2xl p-6 shadow-md sticky top-24 bg-white">
      ...
      <div className="flex items-center justify-between mb-5">
        ...
        {property.isVerified && (
          <span className="text-xs text-blue-600 bg-blue-50 px-3 py-1 rounded-full">✅ Verified Property</span>
        )}
      </div>
      ...
      <div className="grid grid-cols-2 gap-3 mb-3">
        <div className="border border-gray-200 rounded-xl p-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <input type="date" className="text-sm text-gray-700 w-full outline-none" />
          </div>
        </div>
        <div className="border border-gray-200 rounded-xl p-3">
      ...
      <div className="space-y-3 mb-5">
        <div className="flex justify-between text-sm">
          ...
          <span className="font-medium text-gray-800">${property.price.toLocaleString()}</span>
        </div>
        <div className="flex justify-between text-sm">
          <span className="text-gray-500">Security Deposit</span>
          <span className="font-medium text-gray-800">${property.securityDeposit.toLocaleString()}</span>
        </div>
        <div className="flex justify-between text-sm">
        ...
        <div className="border-t border-gray-100 pt-3 flex justify-between font-bold text-gray-900">
          <span>Total</span>
          <span>${property.price.toLocaleString()} <span className="text-xs font-normal text-gray-400">/mo</span></span>
        </div>
      </div>
