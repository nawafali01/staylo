  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex flex-col flex-1 overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto bg-gray-50 p-9 font-sans">
          <div className="mb-7">
            <h1 className="text-2xl font-bold text-gray-900">{settingsData.pageTitle}</h1>
            <p className="mt-1.5 text-sm text-gray-500">
              {settingsData.pageDesc}
            </p>
          </div>
