...
import emailIcon from '../../assets/svg/sign in/email.svg?raw';
import lockIcon from '../../assets/svg/sign in/lock.svg?raw';
import eyeIcon from '../../assets/svg/sign in/eye.svg?raw';
      ...
      <div className="w-full max-w-md">
        ...
        <form className="space-y-5">
          <div>
            ...
            <div className="relative">
              <span className="absolute inset-y-0 left-0 flex items-center pl-4 text-gray-400">
                <span dangerouslySetInnerHTML={{ __html: emailIcon }} className="w-5 h-5" />
              </span>
              <input
                type="email"
          ...
          <div>
            ...
            <div className="relative">
              <span className="absolute inset-y-0 left-0 flex items-center pl-4 text-gray-400">
                <span dangerouslySetInnerHTML={{ __html: lockIcon }} className="w-5 h-5" />
              </span>
              <input
                type="password"
              ...
              <button type="button" className="absolute inset-y-0 right-0 pr-4 flex items-center text-gray-400 hover:text-gray-600">
                <span dangerouslySetInnerHTML={{ __html: eyeIcon }} className="w-5 h-5" />
              </button>
            </div>
          </div>
